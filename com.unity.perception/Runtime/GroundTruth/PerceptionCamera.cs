...
namespace UnityEngine.Perception.GroundTruth
{
    ...
    public partial class PerceptionCamera : MonoBehaviour
    {
        ...
        void CaptureRgbData(Camera cam)
        {
            ...
            var captureFilename = $"{Manager.Instance.GetDirectoryFor(rgbDirectory)}/{k_RgbFilePrefix}{Time.frameCount}.jpg";
            var dxRootPath = $"{rgbDirectory}/{k_RgbFilePrefix}{Time.frameCount}.jpg";
